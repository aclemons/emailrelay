...
G::Options Main::Options::spec( bool is_windows )
{
...

	{
		...
		G::Options::add( opt , 's' , "local-delivery-dir" ,
			...
			M::one , "dir" , 30 ,
			t_smtpserver ) ;
				//example: /var/spool/emailrelay/delivery
				//example: C:/ProgramData/E-MailRelay/spool/delivery
				// Enables local delivery of mail messages that have local
				// recipients, as determined by an address verifier.
